...
<div id="wrapper">
  <h1><center><b>Water Billing System of KhaoDin<br><h3>ระบบเก็บค่าน้ำประปาหมู่บ้านเขาดิน ตำบลเขาเจ็ดลูก  อำเภอทับคล้อ  จังหวัดพิจิตร</h3></b></center></h1>
  <div style="color:#F00; font-size:12px; margin-left:1050px;"> 
  <span><?php echo $sessionname;?></span>&nbsp;&nbsp;<a href="logout.php"><span class="btn btn-danger  glyphicon glyphicon-log-out">&nbsp;Logout</span></a>
  </div>
  <ul class="nav nav-pills">
    <li class="btn btn-default btn-xs"><a href="billing.php"><span class="glyphicon glyphicon-home"></span>&nbsp;หน้าแรก</a></li>
    <li class="btn btn-default btn-xs"><a href="clients.php"><span class="glyphicon glyphicon-list"></span>&nbsp;ผู้ใช้น้ำประปา</a></li>
    <li class="btn btn-default btn-xs"><a href="user.php"><span class="glyphicon glyphicon-user"></span>&nbsp;ผู้ใช้ระบบ</a></li>
    <li class="btn btn-default btn-xs"><a href="bill.php"><span class="glyphicon glyphicon-usd"></span>&nbsp;บันทึกค่าน้ำประปา</a></li>
  </ul>
<hr color="#999999" />
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
    <!-------- home panel ----------------------------->
    <h4><b>&nbsp;&nbsp;&nbsp;&nbsp;ยินดีต้อนรับ คุณ<?php echo $sessionname; ?></b></h4>
      <hr color="#000000" />
      
      <div class="col-md-4">
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5 style="font-size:24px; font-weight:bold;">ผู้ใช้น้ำประปา</h5></div>
            </div>
   ...
   <!-----  ######################################### -->
    <div class="col-md-4">
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5 style="font-size:24px; font-weight:bold;">ผู้ใช้ระบบ</h5></div>
            </div>
              <div class="panel-body">
  ...
  <!-----  ######################################### -->
    <div class="col-md-4">
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5 style="font-size:24px; font-weight:bold;">บันทึกการชำระค่าน้ำประปา</h5></div>
            </div>
              <div class="panel-body">
